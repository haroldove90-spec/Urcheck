        ...
        >
          ...
          >
            <div className="flex items-center justify-between pb-3 border-b border-neutral-100 mb-4">
              <span className="text-sm font-bold text-neutral-900">Más Módulos</span>
              <button 
                onClick={() => setShowMoreMenu(false)}
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 p-3.5 rounded-xl border text-left transition-all ${
                      isActive 
                        ? 'bg-neutral-900 text-white border-red-600 font-bold' 
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center relative py-1 transition-colors cursor-pointer ${
                      isActive ? 'text-red-600 font-bold' : 'text-neutral-600 hover:text-neutral-900'
                    }`}
                  >
                    ...
                    {isActive && (
                      <span className="absolute bottom-1 w-6 h-0.5 rounded-full bg-red-600" />
                    )}
                  </button>
                );
              })}
