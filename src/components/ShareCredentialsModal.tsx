      ...
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-neutral-200 overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="flex items-start justify-between pb-3 border-b border-neutral-200">
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-2xl bg-[#138128]/10 text-[#138128] flex items-center justify-center shrink-0">
              <ShieldCheck className="w-6 h-6" />
            </div>
            <div>
              <span className="text-[10px] uppercase font-bold tracking-wider text-[#138128] block">
        ...
        <div className="overflow-y-auto space-y-4 py-4 pr-1 text-xs sm:text-sm">
          ...
          {/* Success banner */}
          <div className="bg-[#0A3142] text-white p-4 rounded-2xl border border-[#082735] shadow-xs">
            <div className="flex items-center justify-between pb-2 border-b border-white/10">
              <span className="text-xs font-semibold text-neutral-300">Colaborador / Usuario</span>
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#0871A0] text-white">
                {data.roleName}
              </span>
            </div>
              ...
              <div>
                ...
                {data.branchName && (
                  <p className="text-xs text-neutral-300 flex items-center gap-1 mt-0.5">
                    <Building2 className="w-3.5 h-3.5 text-[#0871A0]" />
                    {data.branchName}
                  </p>
                )}
              </div>
          ...
          <div className="bg-neutral-50 rounded-2xl border border-neutral-200 p-4 space-y-3">
            <div>
              ...
              <div className="mt-1 flex items-center justify-between bg-white px-3 py-2 rounded-xl border border-neutral-300">
                <a 
                  ...
                  className="font-mono text-xs text-[#0871A0] font-bold hover:underline truncate"
                >
                  {ACCESS_PORTAL_URL}
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-neutral-400 hover:text-[#0871A0] p-1"
                  title="Abrir enlace"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <div className="mt-1 flex items-center justify-between bg-white px-3 py-2 rounded-xl border border-neutral-300 font-mono font-bold text-[#0A3142]">
              ...
              <div>
                ...
                <div className="mt-1 flex items-center justify-between bg-white px-3 py-2 rounded-xl border border-neutral-300 font-mono font-bold text-[#0A3142]">
                  ...
                  <button
                    ...
                    className="text-neutral-400 hover:text-[#0871A0] p-1 cursor-pointer"
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="w-4 h-4 text-[#138128] absolute left-3 top-1/2 -translate-y-1/2" />
                <input
                  type="tel"
                  placeholder="Ej. +52 55 1234 5678"
                  value={editablePhone}
                  onChange={(e) => setEditablePhone(e.target.value)}
                  className="w-full pl-9 pr-3 py-2 rounded-xl border border-neutral-300 text-xs font-mono focus:ring-2 focus:ring-[#138128] bg-white"
                />
              </div>
        ...
        <div className="pt-3 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-2.5">
          ...
          >
            {copied ? (
              <>
                ...
                <span className="text-[#138128]">¡Credenciales Copiadas!</span>
              </>
            ) : (
              <>
          ...
          <div className="w-full sm:w-auto flex items-center gap-2">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-[#138128] hover:bg-[#0e661f] active:scale-95 text-white font-black text-xs shadow-md transition cursor-pointer"
            >
              {/* WhatsApp Icon */}
