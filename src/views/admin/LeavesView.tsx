      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-neutral-200 shadow-xs">
        <div>
          ...
          <p className="text-xs sm:text-sm text-neutral-500 mt-0.5">
            Revisión formal de solicitudes, cálculo de saldos y dictamen de RRHH
          </p>
        </div>
        ...
        {filtered.length > 0 ? (
          filtered.map((leave) => {
            ...
            return (
              <div
                key={leave.id}
                className="bg-white rounded-2xl border border-neutral-200 p-5 shadow-xs hover:border-neutral-300 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4"
              >
                  ...
                  {isPending ? (
                    <>
                      <button
                        ...
                        type="button"
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white transition-all shadow-xs cursor-pointer active:scale-95"
                      >
                      ...
                      <button
                        ...
                        type="button"
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold rounded-xl border border-red-200 text-red-700 hover:bg-red-50 transition-all cursor-pointer active:scale-95"
                      >
                        <X className="w-4 h-4" />
                        <span>Rechazar</span>
                      </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-neutral-200">
            ...
            <textarea
              ...
              className="w-full p-3 text-xs sm:text-sm rounded-xl border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-red-500"
            />
